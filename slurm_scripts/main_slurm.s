...
#SBATCH --mem=128GB
#SBATCH --job-name=XXXXXXXXXXXXXXX
#SBATCH --mail-type=END
#SBATCH --mail-user=${USER}@nyu.edu
#SBATCH --output=XXXXXXXXXXXXXXXXXXX_%j.out
...
TRAIN_CSV=${SCRIPT_DIR}data/fundus_ds/...
VAL_IMGS=${SCRIPT_DIR}data/fundus_ds/...
VAL_CSV=${SCRIPT_DIR}data/fundus_ds/...
